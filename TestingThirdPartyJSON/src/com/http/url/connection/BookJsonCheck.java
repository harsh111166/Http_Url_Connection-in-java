package com.http.url.connection;
...
public class BookJsonCheck {
	...
	public static void main(String[] args) {
		...
		try
		{
			URL url = new URL("https://maps.google.com/maps/api/geocode/json?address=indore&key=AIzaSyDPiz7AhZNfiZRltOf2Kl3FtQrFRQvimQQ");
